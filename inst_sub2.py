...
class Subscribe:
    ...
    def login(self):
        ...
        self.browser.find_element_by_xpath(
            '//*[@id="react-root"]/section/main/div/article/div/div[1]/div/form/div[2]/div/label/input').send_keys(self.log)
        self.browser.find_element_by_xpath(
            '//*[@id="react-root"]/section/main/div/article/div/div[1]/div/form/div[3]/div/label/input').send_keys(self.passwd)
        self.browser.find_element_by_xpath(
...
yourzayka = Subscribe(30, 'D:\Programming\instagram\_anime96.txt', '__yourzayka', '55555dan')
yourzayka.login()
